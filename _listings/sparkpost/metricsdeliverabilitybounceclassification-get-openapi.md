...
x-complete: 0
info:
  title: SparkPost Bounce Classification Metrics
...
paths:
  ...
  /metrics/deliverability/delay-reason:
    get:
      ...
      - Reason
      - Metrics
  /webhooks/12affc24-f183-11e3-9234-3c15c2c818c2:
    get:
      summary: Retrieve Webhook Details
      description: Retrieve details about a webhook by specifying its id in the URI
        path.
      operationId: getWebhooks12affc24F18311e392343c15c2c818c2
      x-api-path-slug: webhooks12affc24f18311e392343c15c2c818c2-get
      parameters:
      - in: header
        name: Accept
      - in: query
    ...
    put:
      ...
      operationId: putWebhooks12affc24F18311e392343c15c2c818c2
      x-api-path-slug: webhooks12affc24f18311e392343c15c2c818c2-put
      parameters:
      - in: header
        name: Accept
      - in: body
    ...
    delete:
      ...
      operationId: deleteWebhooks12affc24F18311e392343c15c2c818c2
      x-api-path-slug: webhooks12affc24f18311e392343c15c2c818c2-delete
      responses:
        200:
          description: OK
      tags:
  ...
  /bounce-domains:
    get:
      summary: List all Bounce Domains
      description: List all bounce domains.
      operationId: getBounceDomains
      x-api-path-slug: bouncedomains-get
      parameters:
      - in: header
        name: Accept
      responses:
      ...
      - Domains
    post:
      summary: Create a Bounce Domain
      description: Create a bounce domain.
      operationId: postBounceDomains
      x-api-path-slug: bouncedomains-post
      parameters:
      - in: header
        name: Accept
      - in: body
  ...
  /metrics/deliverability/time-series:
    get:
      ...
      description: |-
        ...
        |hour |month |
        |day, month |_any_ |
      operationId: getMetricsDeliverabilityTimeSeries
      x-api-path-slug: metricsdeliverabilitytimeseries-get
      parameters:
      - in: header
        name: Accept
      - in: query
      ...
      - Time-Series
      - Metrics
  /recipient-lists/unique_id_4_graduate_students:
    get:
      ...
      description: |-
        ...
        **Note:** The "return_path" in the POST request body applies to SparkPost Elite only.
      operationId: getRecipientListsUnique4GraduateStudents
      x-api-path-slug: recipientlistsunique-id-4-graduate-students-get
      parameters:
      - in: header
        name: Accept
      - in: query
      ...
      - Recipient
      - List
  /metrics/deliverability/attempt:
    get:
      summary: Deliveries By Attempt
      description: Provides aggregate count of deliveries grouped by the attempt number.
      operationId: getMetricsDeliverabilityAttempt
      x-api-path-slug: metricsdeliverabilityattempt-get
      parameters:
      - in: header
        name: Accept
      - in: query
  ...
  /webhooks:
    ...
    post:
      ...
      - Email
      - Webhook
  /metrics/deliverability/delay-reason/domain:
    get:
      summary: Delay Reason Metrics By Domain
      description: Provides deliverability metrics, specific to delay events, grouped
        by the domain and delay reasons.
      operationId: getMetricsDeliverabilityDelayReasonDomain
      x-api-path-slug: metricsdeliverabilitydelayreasondomain-get
      parameters:
      - in: header
        name: Accept
      - in: query
  ...
  /metrics/bindings:
    get:
      summary: Bindings List
      description: |-
        **Note:** This endpoint is available in SparkPost Elite only.

        Returns a list of bindings that the Metrics API contains data on.
      operationId: getMetricsBindings
      x-api-path-slug: metricsbindings-get
      parameters:
      - in: header
        name: Accept
      responses:
  ...
  /inbound-domains:
    get:
      ...
      operationId: getInboundDomains
      x-api-path-slug: inbounddomains-get
      parameters:
      - in: header
        name: Accept
      responses:
    ...
    post:
      ...
      x-api-path-slug: inbounddomains-post
      parameters:
      - in: header
        name: Accept
      - in: body
  ...
  /suppression-list/:
    put:
      summary: Insert or Update List Entries
      description: |-
      ...
      operationId: putSuppressionList
      x-api-path-slug: suppressionlist-put
      parameters:
      - in: header
        name: Accept
      - in: header
  ...
  /metrics/deliverability/domain:
    get:
      summary: Deliverability Metrics by Domain
      description: Provides aggregate metrics grouped by domain over the time window
        specified.
      operationId: getMetricsDeliverabilityDomain
      x-api-path-slug: metricsdeliverabilitydomain-get
      parameters:
      - in: header
        name: Accept
      - in: query
  ...
  /metrics/campaigns:
    get:
      ...
      description: Returns a list of campaigns that the Metrics API contains data
        on.
      operationId: getMetricsCampaigns
      x-api-path-slug: metricscampaigns-get
      parameters:
      - in: header
        name: Accept
      responses:
  ...
  /metrics/nodes:
    get:
      ...
      operationId: getMetricsNodes
      x-api-path-slug: metricsnodes-get
      parameters:
      - in: header
        name: Accept
      responses:
      ...
      - Nodes
      - List
  /metrics/binding-groups:
    get:
      summary: Binding Groups List
      description: |-
        **Note:** This endpoint is available in SparkPost Elite only.

        Returns a list of binding groups that the Metrics API contains data on.
      operationId: getMetricsBindingGroups
      x-api-path-slug: metricsbindinggroups-get
      parameters:
      - in: header
        name: Accept
      responses:
  ...
  /metrics/domains:
    get:
      ...
      operationId: getMetricsDomains
      x-api-path-slug: metricsdomains-get
      parameters:
      - in: header
        name: Accept
      responses:
      ...
      - Domains
      - List
  /tracking-domains/example.domain.com/verify:
    post:
      summary: Verify a Tracking Domain
      description: Initiate a check against the CNAME DNS record for the specified
        tracking domain. The domain's `status` object is returned on success.
      operationId: postTrackingDomainsExample.domain.comVerify
      x-api-path-slug: trackingdomainsexample-domain-comverify-post
      parameters:
      - in: header
        name: Accept
      responses:
  ...
  /metrics/deliverability/bounce-classification:
    get:
      summary: Bounce Classification Metrics
      description: Provides deliverability metrics, specific to bounce events, grouped
        by the bounce classification. (See [Bounce Classification Codes.](https://www.sparkpost.com/docs/bounce-classification-codes))
      operationId: getMetricsDeliverabilityBounceClassification
      x-api-path-slug: metricsdeliverabilitybounceclassification-get
      parameters:
      - in: header
        name: Accept
      - in: query
